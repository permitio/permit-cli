...
import { ComparisonResult, DetailedAuditLog } from '../../../source/components/test/auditTypes.js';
...
describe('DifferenceResultView', () => {
  it('should render audit log information and decision comparison', () => {
    const { lastFrame } = render(<DifferenceResultView result={mismatchResult} />);
...
describe('ResultsView', () => {
  it('should display summary with matches and differences', () => {
    const results: ComparisonResult[] = [matchResult, mismatchResult, errorResult];
