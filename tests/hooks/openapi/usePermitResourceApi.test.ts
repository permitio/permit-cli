...
describe('usePermitResourceApi', () => {
  ...
  it('should list resources', async () => {
    ...
    expect(mockGetFn).toHaveBeenCalledWith('/v2/schema/{proj_id}/{env_id}/resources');
  ...
  it('should update a resource', async () => {
    ...
    const updateResult = await updateResource('testResource', 'Updated Resource');
    ...
    expect(updateResult.data).toEqual({ key: 'resource', name: 'Updated Resource' });
  ...
  it('should create an action', async () => {
    ...
    const actionResult = await createAction('testResource', 'read', 'Read Action');
